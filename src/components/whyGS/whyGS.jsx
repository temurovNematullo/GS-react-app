        ...
        <div class="whyGS-info">
            <ul class="whyGS_info-list">
                ...
                <li class={`WhyInfo whyGS_info__${theme}`}>
                    ...
                    <span class={`WhyText whyGS_infoText__${theme}`}>Возврат удвоенной стоимости каждого замка в случае брака. </span>
                </li>
            
                <li class={`WhyInfo  whyGS_info__${theme}`}>
                    <img src={Evolute} alt="" class="whyGS_info-img"/>
                    <span class={`WhyText whyGS_infoText__${theme}`}>Наносим ваш логотип компании на наш продукт</span>
                </li>
